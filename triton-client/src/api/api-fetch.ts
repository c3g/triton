 ...
 * @returns
 */
export async function tritonGet<T>(route: string, options: RequestInit = {}): Promise<T> {
...
export async function tritonPost<T>(route: string, options: RequestInit = {}): Promise<T> {
	const mergedOptions: RequestInit = {
		...options,
		credentials: 'include',
		method: 'post',
...
export async function tritonDelete<T>(route: string, options: RequestInit = {}): Promise<T> {
	const mergedOptions: RequestInit = {
		...options,
		credentials: 'include',
		method: 'delete',
